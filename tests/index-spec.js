...
describe('Position', function() {
  ...
  it('baseElement绝对定位：', function() {
    ...
    expect(parseInt(pinElement.offset().top, 10)).to.equal(140);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(150);
  });
  ...
  it('baseElement相对定位：', function() {
    ...
    Position.pin(pinElement, { element:baseElement, x: 100, y: 100 });
    expect(parseInt(pinElement.offset().top, 10)).to.equal(100);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(150);
  });
  ...
  it('offsetParent不为body：', function() {
    ...
    Position.pin(pinElement, { element:baseElement, x: 100, y: 100 });
    expect(parseInt(pinElement.offset().top, 10) - parseInt(baseElement.offset().top, 10)).to.equal(100);
    expect(parseInt(pinElement.offset().left, 10) - parseInt(baseElement.offset().left, 10)).to.equal(100);
    offsetParent.remove();
  });
  ...
  it('offsetParent绝对定位：', function() {
    ...
    baseElement.appendTo(offsetParent);
    Position.pin(pinElement, { element:baseElement, x: 100, y: 100 });
    expect(parseInt(pinElement.offset().top, 10)).to.equal(170);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(170);
    offsetParent.remove();
  });
  ...
  it('加号应用：', function() {
    ...
    expect(parseInt(pinElement.offset().top, 10)).to.equal(160);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(290);
  });

  it('减号应用：', function() {
    Position.pin(pinElement, { element:baseElement, x: '100%-20px', y: '50%-15px' });
    expect(parseInt(pinElement.offset().top, 10)).to.equal(130);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(250);
  });

  it('加减号混用：', function() {
    Position.pin(pinElement, { element:baseElement, x: '100%-20px+10px', y: '50%-15px+5px' });
    expect(parseInt(pinElement.offset().top, 10)).to.equal(135);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(260);
  });

  it('0% 的情况', function() {
    Position.pin(pinElement, { element:baseElement, x: '0%', y: '0%' });
    expect(parseInt(pinElement.offset().top, 10)).to.equal(20);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(20);
  });
  ...
  it('Position.VIEWPORT 作为第二个参数（简略）', function() {
    ...
    expect(parseInt(pinElement.offset().top, 10)).to.equal(0);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(0);
  });

  it('Position.VIEWPORT 作为第二个参数（完整）', function() {
    Position.pin(pinElement, {element: Position.VIEWPORT, x: 25, y: 30});
    expect(parseInt(pinElement.offset().top, 10)).to.equal(30);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(25);
  });
  ...
  it('support 0%+10px', function() {
    ...
    expect(parseInt(pinElement.offset().top, 10)).to.equal(100);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(100);
  });
  ...
  it('body 是 absolute 的情况', function() {
    ...
    Position.pin(pinElement, baseElement);
    expect(parseInt(pinElement.offset().top, 10)).to.equal(40);
    expect(parseInt(pinElement.offset().left, 10)).to.equal(40);
  ...
  it('scroll 1000px 之后', function() {
    ...
    Position.pin(pinElement, baseElement);
    expect(parseInt(pinElement.offset().top, 10)>1000).to.be(true);
